...
class UserController extends Controller
{
    ...
    {
        $existing_employee = Employee::where('name',$request->name)->first();
        ...
        return redirect('my-qrcode/'.$employee_id);


    }
    public function ViewUserQrCode($id)
	{
        $employee = Employee::findOrfail($id);
		return view('backEnd.users.viewqrcode',array(
            'id' => $id,
            'employee' => $employee,
        ));
	}
